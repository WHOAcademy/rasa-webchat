...
| `getCurrentJwt`        | `undefined`        | Function, to be specified when passing JWTs (Keycloak tokens) for (re)creating Socket.IO connetions, that defines how to get the current JWT (Keycloak token) of the user in any moment it is called                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
